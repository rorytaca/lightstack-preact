...
class LocationInput extends Component {
  ...
  render() {
    ...
    return (
      <div className="locationInput db pv3 ph3 ba br2">
        <label className="mb2" for="locationInput">Search by location</label>
        <input 
          ref={el => this.input = el}
          className="locationInput__field w-100 ph0 mt1 outline-0 bn"
          id="locationInput"
          type="text" 
